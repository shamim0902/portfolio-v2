...
export function AboutSection() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-cyan-500/10 blur-[110px]" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.1fr,0.9fr]">
          <motion.article className="tilt-card holo-card rounded-xl p-5 reveal-item">
          ...
          <motion.article className="tilt-card holo-card rounded-xl p-5 reveal-item lg:col-span-2">
            <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-cyan-700 dark:text-cyan-400">
              Technical Stack
            </h3>
